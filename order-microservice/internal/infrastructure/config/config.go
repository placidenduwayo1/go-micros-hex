...
func (app *AppConfig) LoadConfig() {
	...
	app.CustomerBaseUrl = getEnv("CUSTOMER_BASE_URL", "http://localhost:8081/api/v1/customers")
	app.ProductBaseUrl = getEnv("CUSTOMER_BASE_URL", "http://localhost:8082/api/v1/products")
}
